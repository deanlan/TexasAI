...
from texasgpt.util import AppConfig
from texasgpt.util.annotations import PublicAPI
...
class ComponentType(str, Enum):
    WORKER_MANAGER = "texasgpt_worker_manager"
    WORKER_MANAGER_FACTORY = "texasgpt_worker_manager_factory"
    MODEL_CONTROLLER = "texasgpt_model_controller"
    MODEL_REGISTRY = "texasgpt_model_registry"
    MODEL_API_SERVER = "texasgpt_model_api_server"
    MODEL_CACHE_MANAGER = "texasgpt_model_cache_manager"
    PLUGIN_HUB = "texasgpt_plugin_hub"
    MULTI_AGENTS = "texasgpt_multi_agents"
    EXECUTOR_DEFAULT = "texasgpt_thread_pool_default"
    TRACER = "texasgpt_tracer"
    TRACER_SPAN_STORAGE = "texasgpt_tracer_span_storage"
    RAG_GRAPH_DEFAULT = "texasgpt_rag_engine_default"
    AWEL_TRIGGER_MANAGER = "texasgpt_awel_trigger_manager"
    AWEL_DAG_MANAGER = "texasgpt_awel_dag_manager"
    UNIFIED_METADATA_DB_MANAGER_FACTORY = "texasgpt_unified_metadata_db_manager_factory"
    CONNECTOR_MANAGER = "texasgpt_connector_manager"
    AGENT_MANAGER = "texasgpt_agent_manager"
    RESOURCE_MANAGER = "texasgpt_resource_manager"
    VARIABLES_PROVIDER = "texasgpt_variables_provider"
    FILE_STORAGE_CLIENT = "texasgpt_file_storage_client"
...
class SystemApp(LifeCycle):
    ...
    def _build(self):
        ...
        if not self.app:
            ...
            return
        from texasgpt.util.fastapi import register_event_handler
