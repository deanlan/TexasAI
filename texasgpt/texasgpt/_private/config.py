...
from texasgpt.util.singleton import Singleton
...
class Config(metaclass=Singleton):
    ...
    def __init__(self) -> None:
        ...
        self.TEXAS_WEBSERVER_PORT = int(os.getenv("TEXAS_WEBSERVER_PORT", 5670))
        ...
        from texasgpt.core._private.prompt_registry import PromptTemplateRegistry
        ...
        # texasgpt meta info database connection configuration
        ...
        self.LOCAL_DB_NAME = os.getenv("LOCAL_DB_NAME", "texasgpt")
        ...
        # Log level
        self.texasgpt_LOG_LEVEL = os.getenv("texasgpt_LOG_LEVEL", "INFO")
        ...
        # global texasgpt api key
        self.API_KEYS = os.getenv("API_KEYS", None)
        self.ENCRYPT_KEY = os.getenv("ENCRYPT_KEY", "your_secret_key")

        # Non-streaming scene retries
        self.texasgpt_APP_SCENE_NON_STREAMING_RETRIES_BASE = int(
            os.getenv("texasgpt_APP_SCENE_NON_STREAMING_RETRIES_BASE", 1)
        )
        # Non-streaming scene parallelism
        self.texasgpt_APP_SCENE_NON_STREAMING_PARALLELISM_BASE = int(
            os.getenv("texasgpt_APP_SCENE_NON_STREAMING_PARALLELISM_BASE", 1)
        )
