...
class OpenTelemetrySpanStorage(SpanStorage):
    ...
    def append_span(self, span: Span):
        ...
        if span_id in self.spans:
            ...
            otel_span.set_attribute("texasgpt_trace_id", span.trace_id)
            otel_span.set_attribute("texasgpt_span_id", span.span_id)

            if span.parent_span_id:
                otel_span.set_attribute("texasgpt_parent_span_id", span.parent_span_id)
