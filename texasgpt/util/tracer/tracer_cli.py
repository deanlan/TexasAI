...
from texasgpt.configs.model_config import LOGDIR
from texasgpt.util.tracer import SpanType, SpanTypeRunName

logger = logging.getLogger("texasgpt_cli")


_DEFAULT_FILE_PATTERN = os.path.join(LOGDIR, "texasgpt*.jsonl")
