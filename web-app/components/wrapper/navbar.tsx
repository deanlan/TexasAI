        ...
        <div className="flex min-w-full fixed justify-between p-2 border-b z-10 dark:bg-black dark:bg-opacity-50 bg-white">
            <div className="flex justify-between w-full min-[825px]:hidden">
                <Dialog>
                    ...
                    <SheetContent side="left">
                        <SheetHeader>
                            <SheetTitle>AI Texas Hold'em Pokers</SheetTitle>
                        </SheetHeader>
            ...
            <NavigationMenu>
                ...
                <NavigationMenuList>
                    ...
                    {config?.features?.play && <NavigationMenuItem className="max-[825px]:hidden">
                    ...
                    {config?.features?.price && <NavigationMenuItem className="max-[825px]:hidden">
                    ...
                    <NavigationMenuItem className="max-[825px]:hidden">
                        <Link href="https://discord.com/invite/N3kad5yx9J" legacyBehavior passHref>
                            <Button variant="ghost">
                                Join Our Discord
                            </Button>
                        </Link>
